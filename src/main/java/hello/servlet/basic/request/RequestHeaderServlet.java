...
//        printStartLine(request);
    ...
    private void printStartLine(HttpServletRequest request) {
        System.out.println("ㅡㅡㅡㅡㅡ REQUEST LINE start ㅡㅡㅡㅡㅡ");
        System.out.println("request.getMethod() = " + request.getMethod());
        System.out.println("request.getProtocal() = " + request.getProtocol());
        System.out.println("request.getQueryString() = " + request.getQueryString());
        System.out.println("request.isSecure() = " + request.isSecure());
        System.out.println("ㅡㅡㅡㅡㅡ REQUEST LINE end   ㅡㅡㅡㅡㅡ");
    }

    private void printHeaders(HttpServletRequest request) {
        System.out.println("ㅡㅡㅡㅡㅡ Headers start ㅡㅡㅡㅡㅡ");
...
//        }
        ...
        System.out.println("ㅡㅡㅡㅡㅡ Headers end   ㅡㅡㅡㅡㅡ");
    }
